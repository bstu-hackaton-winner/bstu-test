                ...
                <div class="card">
                    <div class="card-header">
                        <div style="float: left;">
                            <h5>Тесты пользователя <?=$current_user->get_name()?> (ID<?=$current_user->get_id()?>)</h5>
                        </div>
                        <form class="create-quiz-title">
                            <a href="/apanel/users.php"><button class="btn btn-info btn-round" ><i class="ti-arrow-left"></i> Вернуться назад</button></a>
                        </form>
                    </div>
                                    ...
                                    <div class="card quiz-card">
                                        ...
                                        <ul class="list-group list-group-flush">
                                            ...
                                            <li class="list-group-item" style="background-color: #EEE;">
                                                <?php if($quiz->is_locked($link, $current_user->get_sub()->get_max_quizzes())){ ?>
                                                    <div class="actions">
                                                        Опрос заблокирован
                                                ...
                                                <?php } else { ?>
                                                    <div class="actions">
                                                        Действия:
                                                        <div class="actions-icons">
                                                            <i onclick="show_quiz_link(`<?=$seo_link_base.$quiz->get_seo_link()?>`);" data-bs-toggle="tooltip" title="Ссылка на опрос" style="color: #122D52;" class="fas fa-link"></i>
