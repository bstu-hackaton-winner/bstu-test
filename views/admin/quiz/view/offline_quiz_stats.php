                ...
                <div class="card">
                    <div class="card-header">
                        <div style="float: left;">
                            ...
                            <span>Владелец: <?=$current_user->get_name()?> (ID<?=$current_user->get_id()?>)</span>
                        </div>
                        <form class="create-quiz-title">
                            <a href="/apanel/offline.php?user=<?=$current_user->get_id()?>"><button class="btn btn-info btn-round" ><i class="ti-arrow-left"></i> Вернуться назад</button></a>
                        </form>
                    </div>
                    <div class="card-block">
                        <?=$notify?>
