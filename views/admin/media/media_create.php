            ...
            <div class="main-body">
                <div class="card">
                    <div class="card-header">
                        <h5>Загрузка медиафайла</h5>
                        <span>Не забудьте сохранить изменения</span>
                    </div>
                    <div class="card-block">
                        <?=$notify?>
                        <form method="POST" enctype="multipart/form-data" action="/apanel/media.php">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input name="media_name" type="text" min='1' class="form-control" required>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <button type="submit" class="btn btn-success">Загрузить</button><br><br>
                        </form>
                    </div>
                </div>
            </div>
