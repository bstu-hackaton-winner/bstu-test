...
//    }
    ...
    $current_user = new User($link, (int) $_GET['user']);
    $quizzes = Quiz::get_quizzes_list($link, $current_user->get_sub()->get_max_quizzes(), 1, $current_user->get_id());
}

include($_SERVER['DOCUMENT_ROOT']."/views/admin/header.php");
switch($ACTION){
    case "edit":
        include($_SERVER['DOCUMENT_ROOT'] . "/views/admin/quiz/edit/offline_quiz_edit.php");
        break;
    case "stats":
        include($_SERVER['DOCUMENT_ROOT'] . "/views/admin/quiz/view/offline_quiz_stats.php");
        break;
    case "session":
        include($_SERVER['DOCUMENT_ROOT'] . "/views/admin/quiz/view/offline_quiz_session.php");
        break;
    default:
        include($_SERVER['DOCUMENT_ROOT'] . "/views/admin/quiz/view/offline_quiz_list.php");
        break;
}
